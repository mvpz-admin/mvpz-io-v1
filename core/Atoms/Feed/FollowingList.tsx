...
//       endpoint: `${process.env.NEXT_PUBLIC_APP_URL}/api/fanzone/user/follower/followingList`,
//     });
...
//               ) : null}
//             </article>
//            {followerLoading? <Loader size={10} /> : <span
//               className="text-[8px] cursor-pointer text-red-500"
...
//         <article className="text-sm">My Following</article>
