...
const AthleteTribeCard = ({ tribe, loading }) => {
  ...
  return (
    <div className="relative w-full  border border-white border-opacity-20 rounded-xl flex flex-col overflow-hidden pb-5">
      ...
      <div className="relative w-full md:px-10 px-5 space-y-5">
        ...
        <div className=" w-full flex md:flex-row flex-col md:justify-between md:items-end space-y-2">
          ...
          {loading ? (
            ...
            <div
              className="flex justify-center items-center px-3 py-2 border border-white border-opacity-10 rounded-lg backdrop-blur-md font-inter font-bold cursor-pointer  bg-primary"
        ...
        <div className="relative w-full   md:py-5 py-0">
          {loading ? (
            <div>
              <Skeleton
            ...
            <>
              {tribe?.about && (
                <div className="md:max-w-[75%] w-full mb-2">
                  <article className="font-inter md:text-[14px] text-[12px] font-medium">
                    {tribe?.about?.substring(0, 100)}...
                  </article>
                </div>
              )}
            </>
...
export default AthleteTribeCard;
