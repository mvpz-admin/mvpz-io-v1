...
const ClaimCards = ({ cards }) => {
  ...
  const handleRevealAll = () => {
    ...
    // Reveal all cards with a staggered delay
    const unrevealed = Array.from({ length: cards.length }, (_, i) => i).filter(
  ...
  return (
    <div
      ...
      id="reavelpage"
    >
      <div className="min-h-screen py-8 sm:py-12 px-4 sm:px-6 lg:px-8 backdrop-brightness-75">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-xs sm:text-sm text-gray-300 mb-6 sm:mb-8">
              Swipe to explore and click to reveal your rewards
            </p>
              ...
              {cards.map((imageUrl, index) => (
                <SwiperSlide key={index} className="!w-auto">
                  <SuccessCard
                    ...
                    hasRevealStarted={
                      hasRevealStarted &&
                      (currentRevealIndex === index || isRevealingAll)
                    }
          ...
          {allCardsRevealed && (
            ...
            >
              <button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-purple-600 text-white rounded-xl font-bold text-xs sm:text-sm hover:bg-purple-700 transition-colors duration-300 shadow-lg hover:shadow-purple-500/25 "
              >
...
const SuccessCard = ({
  ...
  return (
    <div
      className={`relative w-[280px] sm:w-[300px] h-[380px] sm:h-[400px] mx-auto cursor-pointer ${
    ...
    >
      ...
      >
        ...
        <div
          className="absolute w-full h-full rounded-xl bg-gradient-to-br from-purple-600 to-blue-700"
          style={{
