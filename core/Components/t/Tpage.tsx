...
const TPage = ({ tribeId }) => {
  ...
  return (
    <TProfileBar pageData={pageData} tribeId={tribeId} pageDataLoading={pageDataLoading}>
      {/* /* Athlete More Info  */}
      ...
      {pageDataLoading ? (
        ...
        <div className="md:max-w-[75%] w-full mb-2">
         ...
         {!pageDataLoading && (<div className="flex justify-start items-center gap-3 text-primary ">
          <FaInstagram size={18} />
          <FaXTwitter size={18} />
          <FaTiktok size={18} />
        </div> )}
