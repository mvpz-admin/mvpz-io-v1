...
//         const tipCount = await prisma.athleteTips.count({
//           where: {
//             fromUserId,
...
//       const paymentAttempt = await prisma.athleteTips.create({
//         data: {
//           amount: tipAmount,
//           fromUserId,
...
//         },
//         mode: "payment",
//         success_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/tribeAthlete/success?paymentId=${paymentAttempt.id}&callbackURL=${callbackURL}`,
//         cancel_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/tribeAthlete/failure?paymentId=${paymentAttempt.id}&callbackURL=${callbackURL}`,
//         shipping_address_collection: { allowed_countries: ["US"] },
//         allow_promotion_codes: true,
//         shipping_options: [],
//       });

//       await prisma.athleteTips.update({
//         where: {
