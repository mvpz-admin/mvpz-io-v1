...
//         const tipCount = await prisma.tribeShoutsTips.count({
//           where: {
//             fromUserId,
//             postId,
...
//       const paymentAttempt = await prisma.tribeShoutsTips.create({
//         data: {
//           amount: tipAmount,
//           fromUserId,
...
//         },
//         mode: "payment",
//         success_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/tribeShouts/success?paymentId=${paymentAttempt.id}&callbackURL=${callbackURL}`,
//         cancel_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/tribeShouts/failure?paymentId=${paymentAttempt.id}&callbackURL=${callbackURL}`,
//         shipping_address_collection: { allowed_countries: ["US"] },
//         allow_promotion_codes: true,
//         shipping_options: [],
//       });

//       await prisma.tribeShoutsTips.update({
//         where: {
