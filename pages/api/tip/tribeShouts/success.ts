...
//         const paymentInfo = await prisma.tribeShoutsTips.update({
//           where: {
...
//         res.redirect(
//           `${callbackURL}?paymentType=tip&paymentStatus=success&tipFor=ts&paymentId=` +
//             paymentId
//         );
//       } catch (error) {
//         return await prisma.logError.create({
//           data: {
//             apiName: "/api/tip/tribeShouts/success",
//             collection: "tribeShoutsTips & stripePayout",
//             errorLog: `${error}`,
//             title: "Error While creating tribe shout tip ",
//           },
//         });
//       }
//     } else {
