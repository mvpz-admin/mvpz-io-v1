...
//             message: `You received a $${paymentInfo?.amount} tip from ${paymentInfo?.fromUser?.username}.`,
//             userId: paymentInfo.toUserId,
//             url : `${process.env.NEXT_PUBLIC_APP_URL}/profile/earnings`
//           },
//         });
...
//         res.redirect(
//           `${callbackURL}?paymentType=tip&paymentStatus=success&tipFor=tp&paymentId=` +
//             paymentId
//         );
//       } catch (error) {
//         return await prisma.logError.create({
//           data: {
//             apiName: "/api/tip/tribePost/success",
//             collection: "tribePostTips & stripePayout",
//             errorLog: `${error}`,
//             title: "Error While creating tribe post tip ",
//           },
//         });
//       }
//     } else {
