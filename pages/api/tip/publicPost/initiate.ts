...
//     if (req.method === "POST") {
//       const body = req.body;
//       const { fromUserId, toUserId, tipAmount, postId } = body;
...
//         const tipCount = await prisma.publicPostTips.count({
//           where: {
//             fromUserId,
//             postId,
...
//       const paymentAttempt = await prisma.publicPostTips.create({
//         data: {
//           amount: tipAmount,
//           fromUserId,
...
//         },
//         mode: "payment",
//         success_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/publicPost/success?paymentId=${paymentAttempt.id}`,
//         cancel_url: `${process.env.NEXT_PUBLIC_APP_URL}/api/tip/publicPost/failure?paymentId=${paymentAttempt.id}`,
...
//       await prisma.publicPostTips.update({
//         where: {
