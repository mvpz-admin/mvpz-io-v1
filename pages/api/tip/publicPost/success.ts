...
//         const paymentInfo = await prisma.publicPostTips.update({
//           where: {
...
//         res.redirect(
//           "/fanzone?paymentType=tip&paymentStatus=success&tipFor=pp&paymentId=" +
//             paymentId
//         );
//       } catch (error) {
//         console.log({
...
//           data: {
//             apiName: "/api/tip/publicPost/success",
//             collection: "publicPostTips & stripePayout",
//             errorLog: `${error}`,
//             title: "Error While creating public post tip ",
//           },
//         });
//       }
//     } else {
