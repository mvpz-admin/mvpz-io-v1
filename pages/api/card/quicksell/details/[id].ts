...
// const calculateTotalEnhancementPrice = ({
//   majorEnhancementPurchases,
//   minorEnhancementPurchases,
// }) => {
...
//   // Calculate total price for major enhancements
//   const totalMajorPrice = majorEnhancementPurchases?.reduce((acc, purchase) => {
//     return acc + (purchase?.nftMajorEnhancement?.price || 0);
//   }, 0);

//   // Calculate total price for minor enhancements
//   const totalMinorPrice = minorEnhancementPurchases?.reduce((acc, purchase) => {
//     return acc + (purchase?.nftMinorEnhancement?.price || 0);
//   }, 0);

//   // Return the total price of all enhancements
//   return totalMajorPrice + totalMinorPrice;
// };
...
//       let totalAmount = calculateTotalEnhancementPrice({
//         majorEnhancementPurchases: card.majorEnhancementPurchases,
//         minorEnhancementPurchases: card.minorEnhancementPurchases,
//       });
...
//       console.log({
//         totalAmount,
//         pruchase: nFTPurchaseCard?.purchasePrice,
//         nFTMintCard: nFTMintCard?.nftEntity?.price,
//       });

//       const getTradeStartingPrice =
//         await prisma.tradeSellingStartPrice.findFirst();
//       let amount = nFTPurchaseCard
//         ? nFTPurchaseCard.purchasePrice + totalAmount
//         : nFTMintCard.nftEntity.price + totalAmount;
